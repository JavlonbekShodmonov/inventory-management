...
export default function DashboardClient({ serverUser, serverSession }: DashboardClientProps) {
  ...
  const isConnected = !!serverUser?.salesforceIntegration;
  const isSynced =
    !!serverUser?.salesforceIntegration?.salesforceAccountId &&
    !!serverUser?.salesforceIntegration?.salesforceContactId;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            {locale === "ru"
              ? "Управляй своими инвентарями и вещами"
              : "Manage your inventories and items"}
          </p>
        </div>

        {/* Salesforce Integration */}
<SalesforceDialog initialIsConnected={isConnected} initialIsSynced={isSynced} />
        {/* Stats */}
